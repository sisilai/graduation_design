            ...
            <div id="body" style="clear: left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <asp:Label ID="WIDout_trade_no" name="WIDout_trade_no" runat="server"></asp:Label>
                        <span>
</span>
                    </dd>
                    <dt>订单名称：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <asp:Label ID="WIDsubject" name="WIDsubject" runat="server"></asp:Label>
                        <span>
</span>
                    </dd>
                    <dt>付款金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <asp:Label ID="WIDprice" name="WIDprice" runat="server"></asp:Label>万元
                        <span>
</span>
                    </dd>
                    <dt>订单描述
：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <asp:Label ID="WIDbody" name="WIDbody" runat="server"></asp:Label>
                        <span></span>
                    </dd>
                    <dt>商品展示地址：</dt>
                    <dd>
