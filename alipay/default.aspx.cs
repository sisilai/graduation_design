...
public partial class _Default : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            WIDout_trade_no.Attributes.Add("readonly", "true");
            WIDsubject.Attributes.Add("readonly", "true");
            WIDprice.Attributes.Add("readonly", "true");
            WIDbody.Attributes.Add("readonly", "true");
