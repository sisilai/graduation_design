<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editCarsInfo.aspx.cs" Inherits="admin_editCarsInfo" validaterequest="false"%>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h1 class="sub-header">编辑汽车信息</h1>
                <form id="form1" runat="server" action="updateCarsPreview.aspx" method="post">
                    <div>
